...
class HomeVM extends ChangeNotifier {
  ...
  bool hasAuthenticatedThisSession = false;

  void setAuthenticatedSession(bool value) {
    hasAuthenticatedThisSession = value;
    notifyListeners();
  }
...
//Setting Home
  ...
  // void callNextOldPage(BuildContext context, NotificationLst item) {
  //   if (item.enTxnCode.toString().toLowerCase() == 'ar') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => AddViewAssetRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'wr') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => WorkRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'tr') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => TravelRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'lap') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => LeaveRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'pr') {
  //     // item.transactionId = 39063;
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => PRRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'mr') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => MRRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'emr') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => EmailRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'tri') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => TicketRaiseRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'rr') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => RoomRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'grn') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => GRNRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'insp') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => InspectionRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'po') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => PurchaseOrderRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'clr') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => EmployeeClearanceRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'vac') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => VacancyRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'srf') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => SRFRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'emp') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => EmployeeRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'hrae') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => ElementRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'jm') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => JobMasterRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'slr') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => SalaryRevisionRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'api') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => ApplicantRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'dl') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => DrivingLicenseRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'da') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => DisciplinaryRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'vio') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => ViolationRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'ai') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => AssetIssueRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'arn') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => AssetReturnRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'eat') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => AssetTransferRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'qo') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => QualityObservationRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'wo') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => WorkOrderPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'sm') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => SupplierMasterPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'la') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => LoanApplicationPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'ls') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => LoanSuspensionPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'lpay') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => LoanPaymentPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'loe') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => LoanExtensionPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'lr') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => LoanRePaymentPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'gp') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => GatePassRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'gpa') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => GatePassAuthorityRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'sod') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => ServiceOrderRequestPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'mp') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => MissingAttendancePage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'pa') {
  //     // item.transactionId = 18853;
  //     // item.transactionId = 18854;
  //     // Navigator.push(
  //     //     context,
  //     //     MaterialPageRoute(
  //     //         builder: (context) =>
  ...
  //     //   refreshView();
  //     // });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'go') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => GoingOutPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'wfr') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => WorkflowRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'er') {
  //     /*
  //                                         Navigator.push(
  //                                                 context,
  //                                                 MaterialPageRoute(
  //                                                     builder: (context) =>
  //                                                         ExitRequestPage(item)))
  //                                             .then((value) {
  //                                           refreshView();
  //                                         });*/
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'edr') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => DocumentRequestPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'se') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => SalesEnquiryPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'so') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => SalesOrderPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'sq') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => SalesQuotationPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'sdn') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => SalesDeliveryNotePage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'si') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => SalesInvoicePage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'pwp') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => ProjectProgressPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'pj') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => ProjectMasterPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'sai') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => AdvanceSalesInvoicePage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'pwc') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => ProjectWorkConfirmation(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'prq') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => PaymentRequest(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'sa') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => StockAdjustmentPage(item))).then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'pwcr') {
  //     Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //                 builder: (context) => ProjectWorkConfirmationReversal(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'ncrm') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => OpportunityPage(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'cinv') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => AdvanceInvoice(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'ncmr') {
  //     Navigator.push(context,
  //             MaterialPageRoute(builder: (context) => CRMProjectEnquiry(item)))
  //         .then((value) {
  //       refreshView();
  //     });
  //   } else if (item.enTxnCode.toString().toLowerCase() == 'coap') {
  //     Navigator.push(
  //         context,
  //         MaterialPageRoute(
  //             builder: (context) => CommercialAppraisal(item))).then((value) {
  //       refreshView();
  //     });
  //   } else {
  //     // item.transactionId = 35610;
  //     // Navigator.push(
  //     //     context,
  //     //     MaterialPageRoute(
  //     //         builder: (context) =>
  ...
  //     // });
  //     AppUtils.showToastGreenBg(
  //         context, "This page is currently under development.");
  //   }
  // }
